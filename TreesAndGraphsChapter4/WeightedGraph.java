...
public class WeightedGraph {
    ...
    private class Edge {
        ...
        @Override
        public String toString() {
           // return  this.from.label + " -> " + this.to.label + " : " + this.weight;
    ...
    public void print() {
        for (Node node: nodes.values()) {
            ...
            if(!nodeEdges.isEmpty()) {
                System.out.println( node + " is connected to " + nodeEdges);
            } else {
    ...
    // a greedy algorithm tries to find the perfect solution to an algorithm by trying all the solutions
    // priority queue
